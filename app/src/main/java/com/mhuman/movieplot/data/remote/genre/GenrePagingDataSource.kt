...
class GenrePagingDataSource(
    ...
    private val repository: GenrePagingRepository by inject()
    ...
    override fun loadBefore(params: LoadParams<Int>, callback: LoadCallback<Int, MovieInfoList>) {
        compositeDisposable.add(
            repository.getGenreMovieList(
                query = query,
                page = params.key,
    ...
    override fun loadAfter(params: LoadParams<Int>, callback: LoadCallback<Int, MovieInfoList>) {
        compositeDisposable.add(
            repository.getGenreMovieList(
                query = query,
                page = params.key,
